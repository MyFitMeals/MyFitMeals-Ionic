...
let BackendService = class BackendService {
    ...
    getHelloWorld() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.plt.is('cordova')) {
                yield this.getHttpNative('http://myfitmeals.herokuapp.com/').then(data => {
                    console.log(data);
                    this.data = JSON.parse(data.data);
                });
            }
            else {
                yield this.getHttp('http://myfitmeals.herokuapp.com/').then(data => {
                    console.log(data);
                    this.data = data;
                });
            }
    ...
    loadRecipes() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.plt.is('cordova')) {
                yield this.getHttpNative('http://myfitmeals.herokuapp.com/recipes').then(data => {
                    console.log(data);
                    this.recipes = JSON.parse(data.data);
                });
            }
            else {
                yield this.getHttp('http://myfitmeals.herokuapp.com/recipes').then(data => {
                    console.log(data);
                    this.recipes = data;
                });
            }
    ...
    loadRecipeById(recipeId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.plt.is('cordova')) {
                yield this.getHttpNative('http://myfitmeals.herokuapp.com/recipes/' + recipeId).then(data => {
                    console.log(data);
                    this.recipe = JSON.parse(data.data);
                });
            }
            else {
                yield this.getHttp('http://myfitmeals.herokuapp.com/recipes/' + recipeId).then(data => {
                    console.log(data);
                    this.recipe = data;
                });
            }
