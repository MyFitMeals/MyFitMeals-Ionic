...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function srcAppComponentsRecipesRecipesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RecipesComponent = /*#__PURE__*/function () {
      function RecipesComponent(sanitizer) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], RecipesComponent.prototype, "recipe", void 0);
    RecipesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return this.getHttpNative('http://myfitmeals.herokuapp.com/').then(function (data) {
                      console.log(data);
                  ...
                  case 6:
                    _context2.next = 8;
                    return this.getHttp('http://myfitmeals.herokuapp.com/').then(function (data) {
                      console.log(data);
                      _this2.data = data;
                    });
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 3;
                    return this.getHttpNative('http://myfitmeals.herokuapp.com/recipes').then(function (data) {
                      console.log(data);
                  ...
                  case 5:
                    _context3.next = 7;
                    return this.getHttp('http://myfitmeals.herokuapp.com/recipes').then(function (data) {
                      console.log(data);
                      _this3.recipes = data;
                    });
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    _context4.next = 3;
                    return this.getHttpNative('http://myfitmeals.herokuapp.com/recipes/' + recipeId).then(function (data) {
                      console.log(data);
                  ...
                  case 5:
                    _context4.next = 7;
                    return this.getHttp('http://myfitmeals.herokuapp.com/recipes/' + recipeId).then(function (data) {
                      console.log(data);
                      _this4.recipe = data;
                    });
