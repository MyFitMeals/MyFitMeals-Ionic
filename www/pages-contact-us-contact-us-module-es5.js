  ...
  function srcAppPagesContactUsContactUsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContactUsPage = /*#__PURE__*/function () {
      function ContactUsPage(pickerController, router, toast, formBuilder) {
        ...
        this.subjects = ["Problème de paiement", "Problème de compte", "Problème de recette"];
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    options = {
                      buttons: [{
                        ...
                        handler: function handler(value) {
                          _this.subjectSelected = true;
                          _this.subject = value.Subjects.text;
                          console.log(value);
                        }
                      }],
                      columns: [{
                  ...
                  case 3:
                    ...
                    picker.present().then(function (res) {
